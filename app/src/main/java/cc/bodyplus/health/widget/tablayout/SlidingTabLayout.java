package cc.bodyplus.health.widget.tablayout;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        int cccc = mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1;
        ...
        mTextsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textsize, sp2px(17));
     ...
     */
    public void setViewPager(ViewPager vp, ArrayList<String> titles) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.view_sliding_tab, null);
