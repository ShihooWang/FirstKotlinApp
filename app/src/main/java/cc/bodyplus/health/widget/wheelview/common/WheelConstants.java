 ...
 */
package cc.bodyplus.health.widget.wheelview.common;
...
public class WheelConstants {
     ...
     * holo皮肤默认选中框颜色
     */
    public static final int WHEEL_SKIN_HOLO_BORDER_COLOR = Color.parseColor("#4dc8ec");
     ...
     * 滚轮滑动时展示选中项延迟时间
     */
//    public static final int LABEL_TEXT_SIZE = App.PHONE_HEIGHT;
//    public static final int LABEL_TEXT_LEFT= UIutils.dip2px(30);
//    public static final int LABEL_TEXT_CENTER = App.PHONE_HEIGHT;
//    public static final int LABEL_TEXT_NONE = App.PHONE_HEIGHT;
