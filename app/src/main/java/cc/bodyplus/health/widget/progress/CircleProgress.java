...
import cc.bodyplus.health.BuildConfig;
...
public class CircleProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mContext = context;
        mDefaultSize = UIutils.dip2px( DEFAULT_SIZE);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mPrecisionFormat = UIutils.getPrecisionFormat(mPrecision);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(UIutils.measure(widthMeasureSpec, mDefaultSize),
                UIutils.measure(heightMeasureSpec, mDefaultSize));
    }
    ...
    private void drawText(Canvas canvas) {
        ...
        Typeface typeFaceYaHei = Typeface.createFromAsset(mContext.getAssets(), "fonts/DIN.ttf");
        mValuePaint.setTypeface(typeFaceYaHei);
        canvas.drawText(String.format(mPrecisionFormat, mValue)+"%", mCenterPoint.x, mValueOffset, mValuePaint);

        if (mHint != null) {
            mHintPaint.setTypeface(typeFaceYaHei);
            canvas.drawText(mHint.toString(), mCenterPoint.x, mHintOffset, mHintPaint);
        }

        if (mUnit != null) {
            mUnitPaint.setTypeface(typeFaceYaHei);
    ...
    public void setPrecision(int precision) {
        ...
        mPrecisionFormat = UIutils.getPrecisionFormat(precision);
    }
