package cc.bodyplus.health.widget.ucrop.view;
...
import cc.bodyplus.health.widget.ucrop.util.CubicEasing;
import cc.bodyplus.health.widget.ucrop.util.RectUtils;
...
public abstract class CropImageView extends TransformImageView {
     ...
     * Given values are interpolated during the animation date.
