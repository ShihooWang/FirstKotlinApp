...
import cc.bodyplus.health.widget.dialog.CustomToast

/**
 * Created by rui.gao on 2018-04-19.
 */
fun Fragment.showToast(content: String): Toast {
    val toast =CustomToast.makeText(App.instance, content, Toast.LENGTH_SHORT)
    toast.show()
    return toast
}
