...
class RecordViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun setText(viewId: Int, text: CharSequence): RecordViewHolder {
    ...
    fun setHintText(viewId: Int, text: CharSequence): RecordViewHolder {
        val view = getView<TextView>(viewId)
        view.hint = "" + text
        return this
    }
     ...
     * @return
     */
    fun setImageResource(viewId: Int, resId: Int): RecordViewHolder {
     ...
     * @return
     */
    fun setImagePath(viewId: Int, imageLoader: HolderImageLoader): RecordViewHolder {
        val iv = getView<ImageView>(viewId)
     ...
     * 设置View的Visibility
     */
    fun setViewVisibility(viewId: Int, visibility: Int): RecordViewHolder {
